...
componentDidMount(){
    ...
    // read categories
    this.serverRequestCat = $.get("http://www.mysite.local/api/category/read.php",
        function (categories) {
            this.setState({
    ...
    this.serverRequestProd = $.get("http://www.mysite.local/api/product/read_one.php?id=" + productId,
        function (product) {
...
onSave = (e) =>{
    ...
    $.ajax({
        url: "http://www.mysite.local/api/product/update.php",
        type : "POST",
